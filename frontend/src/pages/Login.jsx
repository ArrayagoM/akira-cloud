      ...
      <div className="w-full max-w-md">
        ...
        <div className="card">
          ...
          <div className="space-y-3 mb-6">
            <a href={`${import.meta.env.VITE_API_URL?.replace('/api', '') || ''}/api/auth/google`} className="flex items-center justify-center gap-3 w-full py-2.5 rounded-lg border border-gray-700 bg-gray-900 hover:bg-gray-800 transition-colors text-sm text-gray-300">
